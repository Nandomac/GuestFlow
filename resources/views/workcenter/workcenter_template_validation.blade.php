<div class="container mx-auto">
    ...
    <div class="relative w-full max-w-xs mx-auto mt-4 hidden" id="frmTemplateValidation">
        <div id="searchCharacteristicWrapper" class="">
            <x-customs.search
            :api-url="route('workcenter.searchAvailableValidationCharacteristics', ['id' => $workcenter->id, 'search' => ''])"
                    ...
                    <table id="gridTableValidation" class="table striped-table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="!bg-white dark:!bg-neutral-700 border-b border-neutral-200 dark:border-neutral-600 text-center">UOM</th>
