    ...
    <div class="flex items-center justify-between">
        <div class="col-auto">
            <div class="flex flex-wrap items-center gap-[16px]">
                ...
                <h6 class="font-semibold mb-0 dark:text-white">{{env('APP_NAME')}} - {{ Auth::user()->name }}</h6>
...
<button data-dropdown-toggle="dropdownProfile" class="flex justify-center items-center rounded-full" type="button">
    <iconify-icon icon="carbon:user-avatar" width="40" height="40" class="w-32 h-32 object-fit-cover rounded-full"></iconify-icon>
</button>
<div id="dropdownProfile" class="z-10 hidden bg-white dark:bg-neutral-700 rounded-lg shadow-lg dropdown-menu-sm p-3">
    ...
    <div class="max-h-[400px] overflow-y-auto scroll-sm pe-2">
        <ul class="flex flex-col">
            {{-- <li>
                                <a class="text-black px-0 py-2 hover:text-primary-600 flex items-center gap-4" href="{{ route('dashboard') }}">
